...
parser_test.out: parser_test.cpp Parser.o AST_Traversal.o Database.o AST_Assembly.o FileIO.o Relation.o Attribute.o Tuple.o
	$(CXX) $(CFLAGS) parser_test.cpp Parser.o AST_Traversal.o Database.o AST_Assembly.o FileIO.o Relation.o Attribute.o Tuple.o -o parser_test.out
...
Parser.o: Parser.h Parser.cpp AST_Traversal.o AST_Assembly.o Database.o
	$(CXX) -c $(CFLAGS) Parser.cpp
...
AST_Traversal.o: AST.h AST_Traversal.h AST_Traversal.cpp Database.o AST_Assembly.o FileIO.o Relation.o Attribute.o Tuple.o
	$(CXX) -c $(CFLAGS) AST_Traversal.cpp
